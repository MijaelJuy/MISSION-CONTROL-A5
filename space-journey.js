/**
 * Anna OS — Secuencia 3D (Three.js) para intro: cohete, curva espacial,
 * partículas, planetas procedurales y agujero negro estilizado.
 * Módulo ES puro compatible con GitHub Pages (CDN import map → three).
 */
 ...
 * @param {object} [opts]
 * @param {number} [opts.durationSec=24] Duración del recorrido 0→1 sobre la curva
 */
export function createAnnaSpaceJourney(canvas, opts = {}) {
